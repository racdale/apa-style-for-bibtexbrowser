...
function APABibliographyStyle(&$bibentry) {
  ...
  // author
  $typespan = "<span class=type_$type>&nbsp;</span>";
  $coreInfo = $typespan.' <span class="bibauthor">'.$bibentry->getFormattedAuthorsImproved().'</span> (' . $year . "). " . $title;
  ...
  if ($type=="talk") {
    $entry[0] = $title;
    $organization = $bibentry->getField("organization");
    $entry[] = $organization;
    $info = "";
  ...
  if ($type=="symposium") {
    $booktitle = $bibentry->getField("organization");
    $info = "";
    if ($bibentry->hasField('volume')) {
      $volume = $bibentry->getField("volume");
      $info = ", <span class=articleVolume>".$volume."</span>";
  ...
  if ($type=="book") {
    $booktitle = $bibentry->getField("publisher");
    $info = "";
    if ($bibentry->hasField('volume')) {
      $volume = $bibentry->getField("volume");
      $info = ", <span class=articleVolume>".$volume."</span>";
